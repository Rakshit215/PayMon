...
public class Transaction extends AsyncTask<String, String, String> {
    public String link="http://192.168.137.1/paymon/transaction_api.php";
    ...
    protected void onPostExecute(String s) {
        ...
        if (jsonArray == null)
                ...
                Toast.makeText(activity, "No Transaction History", Toast.LENGTH_LONG).show();
            else {


            Intent i=new Intent(activity, TransactionActivity.class);
            i.putExtra("arr",jsonArray.toString());
