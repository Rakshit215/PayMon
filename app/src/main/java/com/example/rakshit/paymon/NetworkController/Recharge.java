...
public class Recharge extends AsyncTask<String, String, String> {
    public String link="http://192.168.137.1/paymon/recharge_api.php";
    ...
    public Recharge(Activity activity,String num,String op,String amt)
    {
        ...
        try {
            ...
            result.append("&");
            result.append(URLEncoder.encode("op", "UTF-8"));
            result.append("=");
            result.append(URLEncoder.encode(op, "UTF-8"));
