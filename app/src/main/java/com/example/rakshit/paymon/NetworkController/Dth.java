 ...
 */
public class Dth extends AsyncTask<String, String, String> {
public String link="http://192.168.137.1/paymon/dth_api.php";
...
public Dth(Activity activity,String card_num,String amt)
        {
...
//            jsonObject=new JSONObject();
        this.activity=activity;
            ...
            try {
                ...
                result.append("&");
                result.append(URLEncoder.encode("card", "UTF-8"));
                result.append("=");
                result.append(URLEncoder.encode(card_num, "UTF-8"));
