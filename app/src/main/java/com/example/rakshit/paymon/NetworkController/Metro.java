 ...
 */
public class Metro extends AsyncTask<String, String, String> {
    public String link="http://192.168.137.1/paymon/metro_api.php";
    ...
    public Metro(Activity activity,String card,String amt)
    {
