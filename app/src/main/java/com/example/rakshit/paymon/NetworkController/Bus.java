 ...
 */
public class Bus extends AsyncTask<String, String, String> {
    public String link="http://192.168.137.1/paymon/bus_api.php";
    ...
    public Bus(Activity activity,String from,String to,String amt)
    {
